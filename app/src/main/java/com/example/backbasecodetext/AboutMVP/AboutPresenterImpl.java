...
public class AboutPresenterImpl implements About.Presenter {
    ...
    public void onSuccess(AboutInfo aboutInfo) {
        ...
        if(aboutViewImpl != null){
            ...
            aboutViewImpl.setCompanyPostalCode(aboutInfo.getPostalCode());
            aboutViewImpl.setCompanyCity(aboutInfo.getCity());
            aboutViewImpl.setAboutInfo(aboutInfo.getDetails());
        }
